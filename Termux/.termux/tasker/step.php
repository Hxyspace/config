...
file_put_contents('.termux/tasker/step/info.log',$time."\n\n",FILE_APPEND);
$file = file_get_contents(".termux/tasker/step/account.json");
...
foreach($account as $user) {
	...
	file_put_contents('.termux/tasker/step/info.log',"\t".$result."\n\n",FILE_APPEND);

	sleep(1);
}
file_put_contents('.termux/tasker/step/info.log',"\n\n",FILE_APPEND);
